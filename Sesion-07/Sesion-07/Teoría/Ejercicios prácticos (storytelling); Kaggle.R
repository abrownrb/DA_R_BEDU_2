...
pelis <- read.csv("/Users/aliciabrown/Documents/BEDU/A2-Estadistica-Programacion-con-R-2020-master/Sesion-07/Teoría/movies.csv",stringsAsFactors = FALSE) # Para evitar que se factoricen las variables categoricas
puntuacion <- read.csv("/Users/aliciabrown/Documents/BEDU/A2-Estadistica-Programacion-con-R-2020-master/Sesion-07/Teoría/ratings.csv", stringsAsFactors = FALSE)
